...
from tensor2tensor.data_generators.problem import TaskDirections as problemTaskDirections
try:
    ...
    def generate_data_decorator(func, dataset_splits):
      ...
      def generate_multiple_separate_data(data_dir, tmp_dir, task_id):
        for split_pair in dataset_splits:
          func(data_dir, tmp_dir, task_id, max_cases=FLAGS.max_cases, specific_split=split_pair["split"])
